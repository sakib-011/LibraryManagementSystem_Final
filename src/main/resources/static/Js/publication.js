document.addEventListener("DOMContentLoaded", () => {
    ...
    const modal = document.getElementById("addPublications");
    ...
    const editModal = document.getElementById("editPublication");
    ...
    const deleteModal = document.getElementById("deletePublication");
...
function triggerSearch(query) {
    ...
    window.location.href = `/publication?searchQuery=${encodeURIComponent(trimmedQuery)}`;
}
