...
public class AllotmentHistoryController {
    ...
    public AllotmentHistoryController(BookAllotmentHistoryService bookAllotmentHistoryService, StudentService studentService, BookService bookService) {
    ...
    @GetMapping("/allotment_history")
    public String allotmentHistory(
...
//            model.addAttribute("")
        ...
        model.addAttribute("allotmentHistory" , getHistory());
        if(searchInput!=null){
            model.addAttribute("allotmentHistory" , searchFiled(searchInput));
        }
    ...
    private List<BookAllotmentHistory> getHistory(){
